<template>
  <NuxtLayout>
    <div class="basicText">
      <div class="global_contentBox_header">
      ...
      <p>
        Carlos Kremm<br>
        Koppoldstra&szlig;e 1<br>
        86551 Aichach
      </p>

      <p>
        Telefon: +49 1575 6900655<br>
        E-Mail: lingualucis@gmail.com
      </p>
      <p>
      ...
      <p>
        Wenn das Social-Media-Element aktiv ist, wird eine direkte Verbindung zwischen Ihrem Endger&auml;t und dem
        Instagram-Server hergestellt. Instagram erh&auml;lt dadurch Informationen &uuml;ber den Besuch dieser
        Website
        durch Sie.
      </p>
      <p>
        Wenn Sie in Ihrem Instagram-Account eingeloggt sind, k&ouml;nnen Sie durch Anklicken des Instagram-Buttons
        die
        ...
        Inhalt
        der &uuml;bermittelten Daten sowie deren Nutzung durch Instagram erhalten.
      </p>
      <p>
      ...
      <p>
        ...
        >https://www.facebook.com/legal/controller_addendum</a>. Laut dieser
        Vereinbarung
      ...
      <p>
        ...
        Details finden Sie hier: <a
          ...
          rel="noopener noreferrer"
        >https://www.facebook.com/legal/EU_data_transfer_addendum</a>, <a
          href="https://privacycenter.instagram.com/policy/" target="_blank"
          rel="noopener noreferrer"
        >https://privacycenter.instagram.com/policy/</a> und <a
      ...
      <p>
        ...
        lit.
        a DSGVO und &sect; 25 Abs. 1 TDDDG, soweit die Einwilligung die Speicherung von Cookies oder den Zugriff auf
        Informationen im Endger&auml;t des Nutzers (z.&nbsp;B. Device-Fingerprinting) im Sinne des TDDDG umfasst.
        Die
        Einwilligung ist jederzeit widerrufbar.
      </p>
      <p>
        Wenn Ihr Browser Google Fonts nicht unterst&uuml;tzt, wird eine Standardschrift von Ihrem Computer genutzt.
      </p>
      <p>
